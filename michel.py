...
ts._out(("Michel","etat_location","Dehors"))
location = StringVar()
location.set("Dehors")
Label(fenetre,textvariable=location).pack(padx=5,pady=5)
ts._out(("Michel","etat_action","Inactif"))
action = StringVar()
action.set("Inactif")
...
def maj():
	etat_action = ts._rd(("Michel","etat_action",str))[2]
	if (etat_action == "Inactif"):
		#Reçoit l'ordre de prendre son service
		ts._in(("Equipe_Entrer",2))
		#Appel Ascenseur
		ts._out(("appel_ascenseur","descendre","Michel"))
		etat_location = "veut descendre"
		print("Michel veut descendre")
		ts._in(("Michel","etat_location",str))
		ts._out(("Michel","etat_location",etat_location))
		location.set(etat_location)
		#Arrivé en bas
		print("Michel attend l'ascenseur")
		ts._in(("ascenseur_arrivé","Michel"))
		print("Michel entrée")
		etat_location = "mine"
		ts._in(("Michel","etat_location",str))
		ts._out(("Michel","etat_location",etat_location))
		location.set(etat_location)
		etat_action = "Travail"
		ts._in(("Michel","etat_action",str))
		ts._out(("Michel","etat_action",etat_action))
	...
	if (etat_action == "Travail"):
		...
		#Appel Ascenseur
		ts._out(("appel_ascenseur","monter","Michel"))
